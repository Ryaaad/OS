...
const Login = () => {
    ...
    return ( 
        ...
        <div className="w-[45vw] bg-white h-[100vh] flex flex-col gap-5 justify-center  items-center" >
            ...
            <input type="text"  placeholder="UserName"  className=" w-[400px] h-[48px] border border-solid border-[#1A73E8] mx-auto px-5  rounded-md focus:outline-none " onChange={(e)=>handleChange(e,0)} />
            <input type="text"  placeholder="Code"  className=" w-[400px] h-[48px] border border-solid border-[#1A73E8] mx-auto px-5 rounded-md focus:outline-none  " onChange={(e)=>handleChange(e,1)} />
